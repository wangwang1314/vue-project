             ...
             <table>
                 <tr>
                    ...
                    <td>
                           <div class="components-container">
                            <div class="editor-container">
                              <UE v-if="mou" :defaultMsg=defaultMsg  :datevalue=contenttext :config=config ref="ue"></UE>
                            </div>
                          </div>
                  ...
                  <tr>
                    <td> </td>
                    <td>
                       <el-button type="primary" @click="comfirmRelease(1)">存为草稿</el-button>   
