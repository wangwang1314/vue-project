<template>
   <div class="de-box">
     ...
     <p class="tit-p">考官审核</p>
     <p class="title-info">培训师信息</p>
     <div class="tab-class">
      <table>
        <tr>
          <td>培训师编号：</td>
     ...
     <div class="tab-class">
       <table>
        <tr>
          <td>段位考官资格：</td>
          <td>原有星级 （{{data.star_slevel}}）
          	<span style="margin-left:40px;">
          		申请等级
          		<i style="color:RGBA(255, 155, 75, 1)">{{data.apply_star}}</i>
          	</span>
          </td>
        </tr>
         <tr>
        ...
        <tr>
          <td>审批意见：</td>
          <td>
             <textarea placeholder="400字以内" v-model="description"></textarea>
          </td>
        </tr>    
        <tr>
          <td>审批机构：</td>
  	 ...
  	 <div class="hr"></div>
     <div class="ex-btnbox" >
       <button class="color"  @click="confirm">提交</button>
