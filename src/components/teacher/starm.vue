       ...
       <table>
        <tr>
         ...
         <tr>
          <td>调整原因：</td>
          <td>
           <textarea placeholder="请输入原因" v-model="result"></textarea>
          </td>
        </tr>
        <tr>
          <td>审批机构：</td>
  ...
  methods:{
    ...
    confirm(val){
     // this.isarr = false;
      ...
      this.$api.post("/staredit",{
       id:this.id,
       star_level:this.star,
